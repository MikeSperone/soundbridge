...
var _grainread = __webpack_require__(12);
...
var _soundbridge = __webpack_require__(23);
...
var _playgroove = __webpack_require__(10);
...
var _playgrain = __webpack_require__(11);
...
var chaiAsPromised = __webpack_require__(50);
...
describe('Soundbridge', function () {
    ...
    describe("setSettings()", function () {
        ...
        it('should return the correct settings', function () {
            ...
            var settings = (0, _soundbridge.setSettings)(json.settings, 0);
    ...
    describe("audio files", function () {
        it('should all exist', function () {
            ...
            return Promise.all([expect(getFile("2_2_4_sheddrips")).to.be.fulfilled, expect(getFile("34sL")).to.be.fulfilled, expect(getFile("albert_tie")).to.be.fulfilled, expect(getFile("ambientcar_factory")).to.be.fulfilled, expect(getFile("ambientfactory")).to.be.fulfilled, expect(getFile("ambientthunderdrips")).to.be.fulfilled, expect(getFile("arleneNR")).to.be.fulfilled, expect(getFile("badprinter")).to.be.fulfilled, expect(getFile("badprinter2")).to.be.fulfilled, expect(getFile("bartonsifter3")).to.be.fulfilled, expect(getFile("boatreverse")).to.be.fulfilled, expect(getFile("bridgesound")).to.be.fulfilled, expect(getFile("bridgesound1")).to.be.fulfilled, expect(getFile("bridgesound3")).to.be.fulfilled, expect(getFile("bridgesound4")).to.be.fulfilled, expect(getFile("buttonholer")).to.be.fulfilled, expect(getFile("c_ray2")).to.be.fulfilled, expect(getFile("carolynNR")).to.be.fulfilled, expect(getFile("churchbells")).to.be.fulfilled, expect(getFile("counteecullen")).to.be.fulfilled, expect(getFile("crickets")).to.be.fulfilled, expect(getFile("dennisfields")).to.be.fulfilled, expect(getFile("dogsbarking")).to.be.fulfilled, expect(getFile("drillingbursts")).to.be.fulfilled, expect(getFile("elevator")).to.be.fulfilled, expect(getFile("elevator_old_mix")).to.be.fulfilled, expect(getFile("facwhistle+mock")).to.be.fulfilled, expect(getFile("facwhistle1srt")).to.be.fulfilled, expect(getFile("ferryboatbarge")).to.be.fulfilled, expect(getFile("flagpole")).to.be.fulfilled, expect(getFile("foghorn2")).to.be.fulfilled, expect(getFile("geese+gulls")).to.be.fulfilled, expect(getFile("glass_breaking")).to.be.fulfilled, expect(getFile("glass_chipping")).to.be.fulfilled, expect(getFile("glass_cutting")).to.be.fulfilled, expect(getFile("glass_ice")).to.be.fulfilled, expect(getFile("greyston2NR")).to.be.fulfilled, expect(getFile("greyston4")).to.be.fulfilled, expect(getFile("grinder")).to.be.fulfilled, expect(getFile("hangerdoor")).to.be.fulfilled, expect(getFile("hammer")).to.be.fulfilled, expect(getFile("heliocopter")).to.be.fulfilled, expect(getFile("laskyrachet")).to.be.fulfilled, expect(getFile("lenfishing")).to.be.fulfilled, expect(getFile("lensugar")).to.be.fulfilled, expect(getFile("localbirds2")).to.be.fulfilled, expect(getFile("marsh")).to.be.fulfilled, expect(getFile("metalhinge1")).to.be.fulfilled, expect(getFile("montagemachine")).to.be.fulfilled, expect(getFile("masefield1")).to.be.fulfilled, expect(getFile("masefield2")).to.be.fulfilled, expect(getFile("mockingbird")).to.be.fulfilled, expect(getFile("mockingbird2x")).to.be.fulfilled, expect(getFile("mosesyoho")).to.be.fulfilled, expect(getFile("motorboatecho")).to.be.fulfilled, expect(getFile("night")).to.be.fulfilled, expect(getFile("paintmixer")).to.be.fulfilled, expect(getFile("piano_hammer")).to.be.fulfilled, expect(getFile("piano_tuning")).to.be.fulfilled, expect(getFile("piano_tuning2")).to.be.fulfilled, expect(getFile("pigeons")).to.be.fulfilled, expect(getFile("pinningmachine")).to.be.fulfilled, expect(getFile("pno_pluck")).to.be.fulfilled, expect(getFile("rightear12")).to.be.fulfilled, expect(getFile("rightear15")).to.be.fulfilled, expect(getFile("rhythmicdrips")).to.be.fulfilled, expect(getFile("rhythmicsdrips")).to.be.fulfilled, expect(getFile("sandwalk")).to.be.fulfilled, expect(getFile("sax")).to.be.fulfilled, expect(getFile("sculpture1")).to.be.fulfilled, expect(getFile("shakesound8")).to.be.fulfilled, expect(getFile("sharonbarge")).to.be.fulfilled, expect(getFile("sidcaesar1")).to.be.fulfilled, expect(getFile("sign+bell")).to.be.fulfilled, expect(getFile("skateboardmono")).to.be.fulfilled, expect(getFile("skateboardstereo")).to.be.fulfilled, expect(getFile("springpeepers")).to.be.fulfilled, expect(getFile("tennis")).to.be.fulfilled, expect(getFile("trolley2")).to.be.fulfilled, expect(getFile("victor_glass")).to.be.fulfilled, expect(getFile("walter2")).to.be.fulfilled, expect(getFile("water1")).to.be.fulfilled, expect(getFile("water3")).to.be.fulfilled, expect(getFile("waterambient2")).to.be.fulfilled, expect(getFile("waves")).to.be.fulfilled, expect(getFile("wavebangbuf")).to.be.fulfilled, expect(getFile("wavebangbuf2")).to.be.fulfilled, expect(getFile("waveslapping")).to.be.fulfilled]);
        });
    });
});
...
describe('Play Class', function () {
    ...
    var audio = '../build/audio/arlene.mp3';
    var context = new AudioContext();
    var XMLHttpRequest = global.XMLHttpRequest;
    var testing = new _play2.default(audio, context);
...
describe('Playgroove Class', function () {
    ...
    it('should start a new instance', function () {
        var audio = '../build/audio/arlene.mp3';
        var context = new AudioContext();
        return new _playgroove2.default(audio, context);
    });
});
...
describe('Grainread Class', function () {
    ...
    it('should start a new grainread class', function () {
        ...
        var audio = '../build/audio/arlene.mp3';
        var context = new AudioContext();
        return new _grainread2.default(audio, context, 1);
    });
});
...
describe('Playgrain Class', function () {
    ...
    it('should start a new play class', function () {
        var audio = '../build/audio/arlene.mp3';
        var context = new AudioContext();
        return new _playgrain2.default(audio, context);
    });
});
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(9)))
...
var _ambient = __webpack_require__(25);

var _ambient2 = _interopRequireDefault(_ambient);
...
function start(settings, ws) {
    ...
    */
    ...
    // Sensors
    var sensor = (0, _jquery2.default)('.sensor');
    var xy = (0, _jquery2.default)('.xy-pad');
    var rate = 1;
    var zeroOut = void 0,
        oneOut = void 0,
        twoOut = void 0,
    ...
    if (samples.a !== "") {
        ...
        var ambient = new _play2.default(audioAmb, context, 0.8);
    }

    var zero = new _playgroove2.default(audioZero, context);
    zero.delaySwitch(delaySettings[0]);

    var one = new _playgroove2.default(audioOne, context);
    one.delaySwitch(delaySettings[1]);

    var two = new _playgrain2.default(audioTwo, context);
    two.scatter = grainSettings[0];
    two.fade = grainSettings[1];
    two.spread = grainSettings[2];
    two.feedback = grainSettings[3];

    var three = new _loop2.default(audioThree, context);
    var threeHold = new _play2.default(audioThreeHold, context);
    ...
    */
    function moveHand(event, id, src) {
        ...
        (0, _jquery2.default)('#' + id).children('.value').text(rate.toFixed(2));
...
exports.compareByInspect = __webpack_require__(42);

/*!
 * Get own enumerable property symbols method
 */

exports.getOwnEnumerablePropertySymbols = __webpack_require__(20);

/*!
 * Get own enumerable properties method
 */

exports.getOwnEnumerableProperties = __webpack_require__(43);

/*!
 * Checks error against a given set of criteria
 */

exports.checkError = __webpack_require__(21);
...
var getOwnEnumerablePropertySymbols = __webpack_require__(20);
...
let checkError = __webpack_require__(21);
